...
class ProductDAOIntegrationTest {
    ...
    void save() throws Exception {
        // Arrange
        ProductEntity productEntity = new ProductEntity("TEST001", "Test", "Test part", 10.0, "kg");

        // Act
        productDAO.save(productEntity);

        // Assert
        assertTrue(productDAO.existsById(productEntity.getProductId()));
        assertDoesNotThrow(() -> productDAO.delete(productEntity.getProductId()));
    }
